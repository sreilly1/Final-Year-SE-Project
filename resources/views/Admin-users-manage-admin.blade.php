...
<body>
    ...
    <header>
        ...
        <h2 class="welcome_text">Manage Administrator Users</h2>
    </header>
                        ...
                        <div class="row">
                            <div class="large-12 medium-12 small-12 columns">
                                ...
                                <dl class="sub-nav">
                                    ...
                                    <dd class="active"><a href="#">Manage Admin Users</a></dd>
                            ...
                            <div class="large-12 medium-12 small-12 columns scroll">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a data-reveal-id="view{{$admin->id}}" href="#">{{$admin->title}}. {{$admin->name}}</a></td>
                                            <td>{{$admin->email}}</td>
                                            <td>{{$admin->role}}</td>
                                            <td><a href="/Admin/{{$user->id}}/Users/Modify/Admin/{{$admin->id}}">Edit</td>
                                        </tr>
                                        <div id="view{{$admin->id}}" class="reveal-modal xlarge" data-reveal>
                                            <div class="row">
                                                <div class="large-4 columns">
                                                    <small>User Full Name:</small>
                                                    <h6>{{$admin->title}}. {{$admin->name}}</h6>
                                                </div>
                                                <div class="large-4 columns">
