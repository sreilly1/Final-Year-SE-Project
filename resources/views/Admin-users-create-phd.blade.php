...
<body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <section class="top-bar-section">
        ...
        <ul class="left">
            ...
            <li class="active"><a href="#">PhD Student</a></li>
        </ul>
    ...
    <header>
        ...
        <h2 class="welcome_text">Create user as "PhD Student"</h2>
    </header>
                        ...
                        <legend class="legend">Title</legend>
                            ...
                            <div class="row">
                                ...
                                <div class="large-12 columns">
                                    <form data-abide action="/Admin/{{$user->id}}/Users/Create/addPhd" role="form" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="large-4 columns">
                                                ...
                                                <input type="hidden" name="role" value="PHD Student" />
