...
<body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <section class="top-bar-section">
        ...
        <ul class="left">
            ...
            <li class="active"><a href="#">Lecturer</a></li>
        </ul>
    ...
    <header>
        ...
        <h2 class="welcome_text">Create user as "Lecturer"</h2>
    </header>
                        ...
                        <legend class="legend">Title</legend>
                            ...
                            <div class="row">
                                ...
                                <div class="large-12 columns">
                                    <form data-abide action="/Admin/{{$user->id}}/Users/Create/Lecturer/addUser" role="form" method="post">
